    ...
    <div className="w-full max-w-[1200px] mx-auto space-y-4 animate-in fade-in duration-700 bg-[#fafaf9]">
      <section className="flex flex-col items-center pt-10">
        ...
        >
          ...
          {/* Hero Image - No borders or shadows to blend with background */}
          <img 
            src={heroImage} 
      ...
      <div className="grid md:grid-cols-3 gap-6 pb-20 px-4 bg-[#fafaf9]">
        <HighlightCard emoji="🏎️" title="Encyclopedia" desc="The technical soul and passion of the motor valley." />
        <HighlightCard emoji="🍯" title="Aceto Oro" desc="Liquid gold aging in the dark, becoming sweeter every year." />
        <HighlightCard emoji="⛪" title="Ghirlandina" desc="The tower that stands tall, a symbol of your heart's desire." />
      </div>
    </div>
  );
};
